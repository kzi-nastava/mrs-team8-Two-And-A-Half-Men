...
import { SheredLocationsService } from 'src/app/service/shered-locations-service';
...
export class LocationPinService {
  ...
  constructor(private mapService: MapService, private sharedLocationsService: SheredLocationsService) {
