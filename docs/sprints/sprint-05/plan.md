...
|----|------------|----------|---------------------------|
| S3.4 | Reset forgotten password | Low | 8 |
| S2.3 | Notes | Low | 3 |
...
| ID | User Story ID | Title | Priority | Estimation (Story Points) |
|----|------|------|----------|---------------------------|
|S2.3-1 | S2.3 |  Notes - backend endpoint | Low | 1 |
|S2.3-2 | S2.3 |  Notes - web page | Low | 1 |
|S2.3-3 | S2.3 |  Notes - mobile page | Low | 1 |
| S3.4-1 | S3.4 |  Reset forgotten password - WebBackend | Low | 5 |
| S3.4-2 | S3.4 |  Reset forgotten password - Mobile | Low | 3 |


## Todo List

- SA.5 - Web app refactor
- S1.1-2 - Drivers registration web page
- S1.5-2 - User ride booking - web page
- S1.6 - Ride scheduling
- S1.11-1 - Selecting favorite route - web page
- S1.14-1 - Starting a ride - web page
- S2.3-1 - Notes - backend endpoint
- S2.3-2 - Notes - web page
- S2.5-3 - Drivers ride history details page - web - visual
- S2.5-6 - Connect frontend with backend for drivers ride history
- S3.1-1 - Time estimate for unregistered user - backend endpoint
- S3.4-1 - Reset forgotten password - WebBackend
- S3.4-2 - Reset forgotten password - Mobile
- S3.5-1 - Driver ride cancelation - backend endpoint
- S3.6-1 - User ride cancelation - backend endpoint
...
- Implement all functionalities for KT2
